...
const LoginModal: React.FC<LoginModalProps> = ({ isOpen, onClose, onLogin }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      {/* Modal Content */}
      <div className="relative bg-white rounded-lg shadow-2xl w-full max-w-[450px] overflow-hidden animate-fadeIn">
        <button 
          onClick={onClose}
        ...
        <div className="p-8">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            {activeTab === 'register' && (
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-[#B88E2F]"
                  required
                />
              </div>
            )}
            ...
            <button
              type="submit"
              className="mt-2 bg-[#B88E2F] text-white py-3 rounded-lg font-semibold hover:bg-[#9c7724] transition-colors shadow-md"
            >
